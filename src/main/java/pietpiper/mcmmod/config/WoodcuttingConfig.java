...
public class WoodcuttingConfig {
    ...
    private static final File CONFIG_FILE = CONFIG_DIR.resolve("woodcutting_xp_config.yml").toFile();
    private static final File DEFAULT_FILE = CONFIG_DIR.resolve("defaults/woodcutting_xp_defaults.yml").toFile();
    ...
    public static void load() {
        try {
            ...
            System.err.println("Failed to load WoodcuttingXPConfig: " + e.getMessage());
        }
    }
    ...
    private static void saveDefault() {
        ...
        try {
            ...
            System.err.println("Failed to save default WoodcuttingXPConfig: " + e.getMessage());
        }
    }
}